...
def prepare(report_path,output_path="generated/application_manifest.json",debug_company=None,debug_title=None,external_id=None,limit=None):
    ...
    priority={("FULL_JD","EXTERNAL_ATS"):0,("FULL_JD","DICE"):1,("FULL_JD","MANUAL_VERIFIED_ATS"):2,("BASE_RESUME_CONSERVATIVE","EXTERNAL_ATS"):3,("BASE_RESUME_CONSERVATIVE","DICE"):4,("BASE_RESUME_CONSERVATIVE","MANUAL_VERIFIED_ATS"):5}
