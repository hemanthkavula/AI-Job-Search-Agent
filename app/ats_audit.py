...
def ats_audit(job,profile,resume_path):
    ...
    unsupported=unsupported_jd_terms(job.description,profile); inferred=inferable_terms(job.description)
    ...
    return {"passed":passed,"keyword_coverage":coverage,"verified_jd_keywords":verified,"missing_supported_keywords":missing,"inferred_supported_terms":inferred,"unsupported_jd_terms":unsupported,"metric_bearing_lines":meaningful,"rules":{"min_keyword_coverage":90,"no_missing_supported_keywords":True,"min_metric_bearing_lines":5,"no_fabricated_keywords":True}}
