...
def ats_audit(job,profile,resume_path):
 ...
 # JD-first policy: complete-JD coverage is measured across the whole resume. Do not
 # reject an otherwise complete tailored resume merely because every required JD
 # technology is not repeated inside Professional Experience. Experience depth stays
 # diagnostic for recruiter-fit reporting, while factual chronology/metrics remain gated.
 experience_gate=True
