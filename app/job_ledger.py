...
LIFECYCLE_STATUSES={
    ...
    "SUBMITTED","SUBMITTED_CONFIRMED","MANUAL_ACTION_REQUIRED","PERMANENT_SKIP","PREPARED",
}
...
PROCESSED_STATUSES={
    ...
    "SUBMITTED","SUBMITTED_CONFIRMED","MANUAL_ACTION_REQUIRED","IN_PROGRESS","PERMANENT_SKIP",
}
