...
<section class="section" id="jobsSection"><div class="sectionHead"><span id="jobsTitle">Jobs</span><span class="count" id="jobCount"></span></div><div class="row head"><div>Job</div><div>Status</div><div>Date Created</div><div>Actions</div></div><div id="jobs"></div></section></main></div><script>
