...
</style></head><body><div class="app"><aside class="side"><div class="brand">💼 Auto Apply<small>Job Application Manager</small></div><div class="nav"><a class="active" href="#dashboard">⌂ &nbsp; Dashboard</a><a href="#jobsSection">▣ &nbsp; Jobs</a><a href="#pipelinesSection">⌘ &nbsp; Pipelines</a><a href="#schedulerCard">□ &nbsp; Scheduler</a><a href="https://github.com/hemanthkavula/AI-Job-Search-Agent" target="_blank">⚙ &nbsp; Settings</a></div><div class="sched" id="schedulerCard"><b>● Scheduler Active</b>Cloudflare schedule enabled</div></aside><main class="main" id="dashboard"><div class="top"><div><h1>👋 Good Morning!</h1><div class="muted">Here's your job application overview.</div></div><div class="datepick" id="todayLabel"></div></div>
