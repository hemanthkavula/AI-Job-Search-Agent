...
def build_prompt(job,profile,audit_feedback=None,coverage_plan=None):
    ...
    prompt={
      ...
      "quality_rules":{
        ...
        "no_repeated_boilerplate":True,"one_coherent_idea_per_bullet":True,"self_check_before_output":True,"experience_bullets_must_be_interview_defensible":True,"experience_bullets_must_show_concrete_engineering_ownership":True,"generic_responsibility_bullets_forbidden":True,"keyword_stuffing_in_experience_forbidden":True,
