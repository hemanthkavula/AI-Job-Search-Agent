...
The COMPLETE JOB DESCRIPTION is the primary technical tailoring source. The master profile is only the source of fixed identity, chronology, employers, roles, locations, dates, and education. Ignore its prior skills and bullet wording when generating tailored content.
Use the supplied pre-generation coverage plan as the authoritative checklist for V1. Cover every item marked include, including material/required JD technologies, responsibilities, and concepts. Use exact JD terminology or a clear semantic equivalent where appropriate. Relevant JD technologies and capabilities should drive Technical Skills even when they do not appear in the master resume.
TECHNICAL SKILLS ORGANIZATION STANDARD: Build the Technical Skills section from the current JD and organize every included skill under a concise, technically professional functional category. Never output an unstructured keyword blob, vague category names, or a category created for only one incidental keyword when it can fit a standard engineering layer. Prefer market-standard data-engineering taxonomy and adapt the categories to the JD. Recommended category vocabulary, used only when relevant: "Programming & Query Languages"; "Data Processing & Distributed Computing"; "ETL/ELT & Data Integration"; "Workflow Orchestration"; "Streaming & Messaging"; "Cloud Platforms & Services"; "Data Warehousing & Lakehouse"; "Databases & Storage"; "Data Modeling & Architecture"; "Data Quality, Governance & Lineage"; "DevOps, IaC & CI/CD"; "Analytics & Business Intelligence"; "AI/ML Data Infrastructure"; "Security & Compliance". Put each technology in the category that best represents its primary role in the target JD, avoid unnecessary duplication across categories, use canonical industry names (for example Apache Spark, Apache Airflow, Google BigQuery, Amazon Redshift, Azure Data Factory), and order categories by relevance to the target role while normally keeping programming/query languages near the top. Category labels themselves must sound technical and recruiter-recognizable, not like JD prose such as "Leadership & Delivery", "Reusable Enterprise Solutions", or "Other Skills". Keep conceptual capabilities such as dimensional modeling, schema evolution, CDC, data lineage, data contracts, batch processing, and stream processing under their appropriate technical category rather than inventing awkward headings.
CRITICAL TAILORING RULE: Technical Skills is not sufficient evidence of fit. For every tailored resume, materially rewrite Professional Experience against the current JD. Do not simply preserve the master bullets while changing Summary/Skills. Across Fidelity, Cigna, and Target, at least 6 bullets total must be clearly JD-specific, and each material hands-on requirement that is truthfully supportable must appear in one or more coherent experience bullets. When a JD-required technology is important to the role, integrate it into a technically meaningful Professional Experience bullet when it can be placed coherently in that employer's domain, rather than leaving it as an isolated keyword. Preserve employer domain truth and fixed facts, but vary responsibilities, emphasis, terminology, and bullet construction for the actual JD.
...
JD-DRIVEN EXPERIENCE RULE: The current JD drives the technical content of Professional Experience. Convert important JD requirements into concrete, technically coherent engineering bullets that make sense for each employer's business domain and the candidate's role. Do not merely copy JD sentences or dump keywords. Every bullet must explain meaningful engineering work: what was built/owned, the relevant data/system, how the technology or approach was used, and why it mattered. Preserve fixed chronology and employer-domain truth. Do not invent certifications, team sizes, project names, numerical metrics, or named business outcomes merely to strengthen alignment.
...
def build_prompt(job,profile,audit_feedback=None,coverage_plan=None):
    ...
    prompt={
      ...
      "quality_rules":{
        ...
        "no_repeated_boilerplate":True,"one_coherent_idea_per_bullet":True,"self_check_before_output":True,"experience_bullets_must_be_interview_defensible":True,"experience_bullets_must_be_ats_aligned":True,"ats_terms_must_be_semantically_integrated":True,"experience_bullets_must_show_concrete_engineering_ownership":True,"experience_bullets_must_fit_target_role_and_employer_domain":True,"generic_responsibility_bullets_forbidden":True,"keyword_stuffing_in_experience_forbidden":True,
      ...
      "output_schema":{
        ...
        "skills":{"technical_functional_category":["JD-relevant technologies/capabilities grouped under concise market-standard data-engineering category names; use canonical technology names, avoid duplicate placement, and order categories by JD relevance"]},
