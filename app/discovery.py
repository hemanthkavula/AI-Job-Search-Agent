...
DIRECT_PROVIDERS=("greenhouse","lever","ashby","smartrecruiters","workday","successfactors","icims","oracle","eightfold","ukg","ultipro","ultipro_ukg","adp_workforce_now")
FALLBACK_ATS_PROVIDERS=(
 "dayforce","recruiting_com","workable","recruitee","teamtailor","bamboohr","phenom","avature",
