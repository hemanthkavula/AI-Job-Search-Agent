...
def run(source_config="data/job_sources.json",registry_path="generated/company_registry.json"):
...
if __name__=="__main__":
    ...
    p.add_argument("--registry",default="generated/company_registry.json")
    a=p.parse_args()
